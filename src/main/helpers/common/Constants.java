...
public class Constants 
{
	...
	public static final String  APLICATIVO_TYPE_INMUEBLES                    			 = "INMUEBLES";
	public static final String  APLICATIO_TYPE_VEHICULOS                    			 = "VEHICULOS";
	public static final String  APLICATIO_TYPE_ACTIVIDADES_ECONOMICAS          			 = "ACTIVIDADES_ECONOMICAS";
	public static final String  APLICATIO_TYPE_TASAS                    			     = "TASAS";
